## 0.11.0 - November 19, 2025

- Remove Android AccessibilityService implementation and permissions
- Introduce UsageStats-based monitor for `streamAppUsage`
- Update examples/docs to rely on Usage Access + overlay permissions
