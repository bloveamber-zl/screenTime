...
abstract class ScreenTimePlatform extends PlatformInterface {
  ...
  Future<Map<String, dynamic>?> getBlockingStatus() {
    throw UnimplementedError('getBlockingStatus() has not been implemented.');
  }

  /// iOS only: present FamilyActivityPicker and return selected bundleIds
  Future<Map<String, dynamic>?> invokeMethod<T>(String method,
      [Map<String, dynamic>? args]) {
    throw UnimplementedError('invokeMethod() has not been implemented.');
  }

  /// iOS: Clear all shields (apps, categories, web domains)
  Future<bool> clearAllShields() {
    throw UnimplementedError('clearAllShields() has not been implemented.');
  }
}
